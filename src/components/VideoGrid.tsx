    ...
    <section id="video-portfolio" className="py-14 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-video w-full bg-slate-950 overflow-hidden">
                  ...
                  {/* Inline quick edit button - ONLY FOR ADMIN */}
                  {isAdmin && (
                    <button
                  ...
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-2 flex-wrap">
                      <div className="flex items-center gap-2">
                        ...
                        {/* PROMINENT: লিংক জমা দিন (Submit Link) BUTTON - ONLY FOR ADMIN */}
                        {isAdmin && (
                          <button
                            type="button"
                    ...
                    {/* QUICK LINK SUBMISSION DRAWER - ONLY FOR ADMIN */}
                    {isAdmin && activeLinkId === video.id && (
                      <div
          ...
          {/* Dotted Card: Add New Video Slide - ONLY FOR ADMIN */}
          {isAdmin && (
            <button
              onClick={handleAddNewSlide}
              type="button"
        ...
        <div className="mt-12 pt-6 border-t border-slate-800/60 flex flex-col items-center justify-center text-center space-y-4">
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            {/* Quick Edit YouTube Channel Link Button - ONLY FOR ADMIN */}
            {isAdmin && (
              <button
